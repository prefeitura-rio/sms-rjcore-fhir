Profile: BRResultadoExameLaboratorial2
Parent: Composition
Id: BRResultadoExameLaboratorial-2.0
...
* section.orderedBy ..0
* section.entry 1.. MS
* section.entry only Reference(BRDiagnosticoLaboratorioClinico2)
* section.entry.reference 1.. N
